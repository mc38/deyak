...
<title></title>
<?php
$link="inner-data/data/report/data-qrc_report/";
?>
            ...
            <div class="form-data">
                ...
                <div class="sub-form">
                    ...
                    <div class="content">
                    	<table border="0">
                        	...
                        	<tr>
                            	<td><label>Sub-Division <span>*</span></label></td>
                                <td class="med"></td>
                                <td></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td colspan="3">
                                    <input id="dtr" type="text" placeholder="Type here" autocomplete="off" spellcheck="false" />
                                </td>
                            </tr>
                            <tr class="gap">
                                <td></td>
                ...
                <div class="sub-form">
                    ...
                    <div class="content-spl" id="data_print">        
                        ...
                        <div class="list-loader_holder">
                            <div id="listload_progressbar" class="list-loader"></div>
                        </div>      
