...
<title></title>
<?php
$link="inner-data/data/settings/data-holiday_list/";
?>
    ...
    <div class="main-container">
    	...
    	<div class="main-panel">
            ...
            <div class="form-data">
                    ...
                    <div class="content">
                    	...
                    	<table border="0">
                            <tr>
                                ...
                                <td class="med"></td>
                                <td><label>Select Holiday</label></td>
                            </tr>
                            <tr class="gap">
                            	<td><input id="h_name" type="text" autocomplete="off" spellcheck="false" placeholder="Type here" value="" /></td>
                                <td class="med"></td>
                                <td><input id="h_date" type="date" autocomplete="off" spellcheck="false" placeholder="Select" value="" /></td>
                            </tr>
                            <tr class="gap">
                            	<td></td>
                                <td class="med"></td>
                            ...
                            <tr>
                                ...
                                <td class="med"></td>
                                <td align="right"><button type="button" style="width:200px; margin-left:0px; margin-right:0px;" onclick="create_h(this);">Add</button></td>
                            </tr>
                        </table>
                    </div>
                </div>
                ...
                <div class="sub-form">
                	<div class="head">Holiday List</div>
                    ...
                    <div class="content-spl" id="data_print">        
                        ...
                        <table border="0" class="content-list" id="h_list"> 
