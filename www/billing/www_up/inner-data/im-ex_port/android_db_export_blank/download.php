			...
			if(mysql_num_rows($subq) ==1){
				...
				//////////////////////////////////////////////////////////////////////////////
					...
					if(sizeof($dtrarr)>0){
						...
						$mq = mysql_query("select * from m_data where c_mydate='". $mydate ."' and c_subdiv_id='". $subd->sid ."' and out_dtrno in ('".$dtrstr."') and in_status='' and c_import_status=0 and c_pass_status=0");
