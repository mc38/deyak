...
<title></title>
<?php
$link="inner-data/user/data-auth_access/";
?>
            ...
            <div class="form-data">
				...
				<div class="sub-form">
                    ...
                    <div class="content">
                    	...
                    	<table border="0">
                            ...
                            <tr class="gap">
                            	<td colspan="3">
                                	<select id="authid" onchange="list_search();">
                ...
                <div class="sub-form">
                    ...
                    <div class="content">
                    	...
                    	<table border="0">
                        	<tr>
                            	<td><label>Page tag</label></td>
                                <td class="med"></td>
                                
                            </tr>
                            <tr class="gap">
                            	<td colspan="3">
                                	<select id="ptid" onchange="get_pagelist(this);">
                                		<option value="">Select Tag</option>
                                        <?php
										$tq = mysql_query("select * from zzpagetag order by srl");
                            ...
                            <tr>
                                ...
                                <td class="med"></td>
                                <td align="right"><button type="button" style="width:200px; margin-left:0px; margin-right:0px;" onclick="create_system(this);">Add page</button></td>
                            </tr>
