...
<div align="center"><button type="button" onclick="print_report();">Print</button></div>
...
if(isset($_POST['s']) && ($_POST['s']!="")){
	...
	if(mysql_num_rows($q) ==1){
		...
		$subsidy_unit = 0;
		$eng_brkup_str = "";
		$en_brkup_no = array("a","b","c","d","e","f");
		$en_brkup_name = array("First","Second","Third","Fourth","Fifth","Sixth");
		$en_brkup = array();
		$en_slab = json_decode(base64_decode($d->in_energy_brkup));
		for($i=0;$i<sizeof($en_slab);$i++){
			$slabdata = $en_slab[$i];
			$en_brkup[$i] = array();
			$en_brkup[$i][0] = "(". $en_brkup_no[$i] .") ". $en_brkup_name[$i] ." ". $slabdata[1] ." Units @ &#8377; ". $slabdata[2] ."/unit";
			$en_brkup[$i][1] = $slabdata[3];

			$eng_brkup_str .='
			<tr>
	        	<td>'. $en_brkup[$i][0] .'</td>
	        	<td class="med_rt">'. $en_brkup[$i][1] .'</td>
            </tr>
			';
			if($subsidy_unit==0){
		...
		echo '
			...
			<html>
				<head>
					...
					<link rel="stylesheet" type="text/css" href="inner-data/print/bill/style/css/bootstrap.min.css" />
					<link rel="stylesheet" type="text/css" href="inner-data/print/bill/style/css/bill_style.css" />
				</head>
				<body>
				<div class="container">
				          ...
				          <tr class="bord color">
				            <td colspan="2"  class="det caps_sm">
				              <table>
				                ...
				                <tr>
				                  <td>DTR</td>
				                  <td style="text-align: right;">'. $d->out_dtrno .'</td>
				                </tr>
				                <tr>
				                  <td>Category</td>
				              ...
				              <div class="barcode" align="center">
				              	<img src="http://www.barcodes4.me/barcode/i2of5/'. $d->in_apdcl_billno .'.png" class="barcode" />
				              </div>
				            </td>
				          </tr>
				        </tbody>
				          ...
				          <tr class="bord color">
				            <td colspan="2"  class="det caps_sm">
				              <table>
				                <tr>
				                  <td>Bill no</td>
				                  <td>'. $d->in_apdcl_billno .'</td>
				                </tr>
				                <tr>
				                  <td>Bill Period</td>
				                  <td>'. date('d/m/Y',$d->out_premeter_read_date) .' to '. date('d/m/Y',$d->in_reading_date) .'</td>
				                </tr>
				                <tr>
				                  <td>Bill Date</td>
				                  <td>'. date('d/m/Y',$d->in_reading_date) .'</td>
				                </tr>
				                <tr>
				                  <td>No of Days</td>
				                ...
				                <tr>
				                  <td>Due Date</td>
				                  <td>'. date('d/m/Y',$d->in_due_date) .'</td>
				                </tr>
				              </table>
				            </td>
				          </tr>
				            ...
				            <td colspan="2" class="det">
				              <table align="center" class="med">
				                ...
				                <tr>
				                  ...
				                  <td></td>
				                  <td></td>
				                  <td>'. round($d->in_net_bill_amount,0) .'</td>
				                </tr>
				                <tr>
				                  <td>Amount in words</td>
				                  <td colspan="3" style="text-transform: capitalize;">'. rupee_2_str(round($d->in_net_bill_amount,0)) .'</td>
				                </tr>
				              </table>
				            </td>
				          ...
				          <tr class="bord color">
				            <td colspan="2" class="det">
				              <table>
				                <tr>
				                  <td>
				                    <span class="let">Under section 56(1) of IE Act 2003 power supply to your premises will be disconnected as per above clause if you fail to pay the billed amount &#8377; '. round($d->in_net_bill_amount,0) .' within >'. date('d/m/Y',$d->in_due_date) .'. Ignore if already paid.</span>
				                  </td>
				                </tr>
				              </table>
				            </td>
				    ...
				    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 padding">
				    	<div style="height: 0px;"><div style="height: 450px;" class="watermark" align="center">
				    		<img src="'. $image_data .'" style="height: 450px;" class="watermark" />
				    	</div></div>
				          ...
				          <tr class="bord color">
				            <td class="det">
				              <table  class="new_tab_child">
				                <tr>
				                  <td rowspan="'. $eng_row .'" class="top">1.</td>
				                  <td colspan="2">Energy Charge</td>
				                </tr>
				                '. $eng_brkup_str .'
				                <tr>
				                  <td>('. $en_brkup_no[$subsidy_no] .')Balance less Govt. subsidy '. $subsidy_unit .' Units @ &#8377; '. $subsidy_rate .'/unit</td>
				                  <td class="med_rt">'. number_format($d->in_subsidy,2) .'</td>
				                </tr>
				                <tr>
				                  <td>2.</td>
				                  <td>Total Energy Charge</td>
				                  <td class="med_rt">'. number_format($d->in_total_energy_charge,2) .'</td>
				                </tr>
				                <tr>
				                  <td>3.</td>
				                  <td>Fixed charges for '. $d->out_connection_load .'/kva/kw, @ &#8377; '. $fcharge_rate .'/kw/kva</td>
				                  <td class="med_rt">'. number_format($d->in_fixed_charge,2) .'</td>
				                </tr>
				                <tr>
				                  <td>4.</td>
				                  <td>Electricity Duty</td>
				                  <td class="med_rt">'. number_format($d->in_electricity_duty,2) .'</td>
				                </tr>
				                <tr>
				                  <td>5.</td>
				                  <td>Meter Rent</td>
				                  <td class="med_rt">'. number_format($d->in_meter_rent,2) .'</td>
				                </tr>
				                <tr>
				                  <td>6.</td>
				                ...
				                <tr>
				                  ...
				                  <td class="med_rt">'. number_format($d->out_adjustment,2) .'</td>
				                </tr>
				                <tr>
				                  <td>8.</td>
				                  <td>FPPPA @ &#8377; '. $d->out_rate_fppa .'/unit X '. $d->in_unit_billed .'</td>
				                  <td class="med_rt">'. number_format($d->in_fppa_charge,2) .'</td>
				                </tr>
				                <tr>
				                  <td>9.</td>
				                ...
				                <tr>
				                  <td>10.</td>
				                  <td>Arrears (a) Principal '. number_format($d->out_principal_arrear,2) .' (b) Surcharges '. number_format($d->out_arrear_surcharge,2) .'</td>
				                  <td class="med_rt">'. $parr .'</td>
				                </tr>
				                <tr>
				                  <td>11.</td>
				                  <td>Current surcharges on arrear principal</td>
				                  <td class="med_rt">'. number_format($d->in_current_surcharge,2) .'</td>
				                </tr>
				                <tr>
				                  <td>12.</td>
				                ...
				                <tr>
				                  ...
				                  <td class="med_rt"><b>'. number_format($d->in_net_bill_amount,2) .'</b></td>
				                </tr>
				              </table>
				              <table  class="new_tab_child">
				                <tr>
				    ...
				    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padding">
				       <table class="new_tab">
				          <tr class="bord">
				            ...
				            <td class="wid_right"><b>Centralized Customer Care Number<br>1912<br>0361-231 3069<br>3061-231 3082<br>+91 96780 84219<br><span style="display:none;">Pay bills online www.apdcl.org</span><b></td>
				          </tr>
				      </table>
				    </div>
	...
	echo '<div align="center">Data problem</div>';
}
/*
}
else{
