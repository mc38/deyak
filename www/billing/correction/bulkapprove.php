...
$u = 0;		
		$q = mysql_query("select * from m_data where c_import_status=1 and c_pass_status=0 and in_status<>''");
		if(mysql_num_rows($q) >0){
			...
			*/
			...
			mysql_query("update m_data set c_done='1',c_pass_status='1',c_pass_datetime='". $datetime ."',c_pass_user='". $u ."' where id='". $id ."'");
