...
echo '
			<div>
				<span class="head_text">Management Verification</span>
			</div>
			<br/><br/>
	...
	$spl_count = 0;
	if(mysql_num_rows($q) >0){
		$data_total = mysql_num_rows($q);
		echo '
		<h1>Total - '. $data_total .'</h1>
		...
		while($d = mysql_fetch_object($q)){
			...
			$mch = $d->out_principal_arrear / $d->in_current_demand;
			if(($mch<=5) && ($d->in_current_surcharge>0) && ($d->in_current_surcharge == $ch_bill_data[11])){
				$spl_count++;
			}
		...
		echo '
			<tr style="background:#ddd; border-bottom:2px solid #000;">
				...
				<td align="center">'. $error_cday.' / '. $data_total .'</td>
				<td align="center">'. $error_cunit .' / '. $data_total .'</td>
				<td align="center">-</td>
				<td align="center">'. $error_unit_pf .' / '. $data_total .'</td>
				<td align="center">'. $error_unit_b .' / '. $data_total .'</td>

				<td>'. $error_slab .' / '. $data_total .'</td>
				<td align="right">'. $error_eng_chrg .' / '. $data_total .'</td>
				<td align="right">'. $error_subsidy .' / '. $data_total .'</td>
				<td align="right">'. $error_tec .' / '. $data_total .'</td>
				<td align="right">'. $error_fix_chrg .' / '. $data_total .'</td>
				<td align="right">'. $error_mrent .' / '. $data_total .'</td>
				<td align="right">'. $error_eduty .' / '. $data_total .'</td>
				<td align="right">'. $error_fppa .' / '. $data_total .'</td>
				<td align="right">'. $error_cd .' / '. $data_total .'</td>
				<td align="right">-</td>
				<td align="right">-</td>
				<td align="right">'. $error_cs .' / '. $data_total .'</td>
				<td align="right">'. $error_ta .' / '. $data_total .'</td>
				<td align="right">-</td>
				<td align="right">'. $error_nba .' / '. $data_total .'</td>
			</tr>
		</table>
		';
	}
