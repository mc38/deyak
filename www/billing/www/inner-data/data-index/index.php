...
<div class="main-container">
	<div class="content">
		...
		function downloadapp(d){
			...
			link_data[1] = "http://apdcl.deyak.in/app/DEYAKAgentBillingLite_v_2_0_0.apk";
			window.location.href=link_data[d];
		}
		</script>
		<div><button class="down" type="button" onclick="downloadapp(0);">Google Play Store DEYAK App</button></div>
		<div><button class="down" type="button" onclick="downloadapp(1);">DEYAK App Offline Download</button></div>
