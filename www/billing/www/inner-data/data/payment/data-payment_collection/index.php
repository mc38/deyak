...
<title></title>
<?php
$link="inner-data/data/payment/data-payment_collection/";
?>
                    ...
                    <div class="content">
                    	<table border="0">
                            ...
                            <tr>
                                ...
                                <td class="med"></td>
                            	<td>
                                	<input id="cdate" type="date"  autocomplete="off" spellcheck="false" value="" placeholder="Type Here" />
                                </td>
                            </tr>
							<tr class="gap">
                            	<td></td>
                            ...
                            <tr>
                                <td>
                                	<input type="radio" name="lgov" value="0" onclick="list_for(this);" checked="checked" style="position:relative; top:1px;" />
                                   	<span>Not for Subdivision</span> 
                                </td>
                                <td class="med"></td>
                            	<td>
                                	<input type="radio" name="lgov" value="1" onclick="list_for(this);" style="position:relative; top:1px;" />
                                   	<span>For Subdivision</span>
                                </td>
                            </tr>
							<tr class="gap">
                            	<td></td>
