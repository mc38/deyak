...
function pay_edit(doc){
	
	var id = doc.value;
	var d = document.getElementById("pd_"+ id).value;
	if( d !="" ){
		doc.setAttribute("disabled","disabled");
...
function list_search(){
	...
	var cd = document.getElementById("cdate").value;
	
	if(str !="" && smon !="" && syar !=""){
		var sdate = "01-"+ smon +"-"+ syar;
		
		var data = [str.toLowerCase(),sdate,aid,cd];
