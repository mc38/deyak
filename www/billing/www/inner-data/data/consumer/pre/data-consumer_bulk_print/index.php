...
<title></title>
<?php
$link="inner-data/data/consumer/data-consumer_bulk_print/";
?>
    ...
    <div class="main-container">
    	...
    	<div class="main-panel">
            ...
            <div class="form-data">
                ...
                <div class="sub-form">
                    ...
                    <div class="content">
                    	<table border="0">
                            ...
                            <tr>
                            	<td><label>Agent <span>*</span></label></td>
                                <td class="med"></td>
                                <td><label>Reading Date</label></td>
                            </tr>
                            <tr>
                            	<td>
                                	<select id="agent_id">
                            ...
                            <tr>
                            	<td colspan="3">
                                    ...
                                    <button type="button" style="width:120px; margin-right:10px; float:right;" onclick="clear_control(this);">Clear</button>
                ...
                <div class="sub-form">
                	<div class="head">Print Data</div>
                    <div class="content-spl" id="data_print">        
                           
                        <textarea class="list-scroll stylist-scroll" id="data_list" style="height:1200px; text-align:left; overflow:scroll; font-size:9px; font-family:'Courier New', Courier, monospace; font-weight:bold;" readonly="readonly"></textarea>
