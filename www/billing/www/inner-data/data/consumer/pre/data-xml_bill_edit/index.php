...
<title></title>
<?php
$link="inner-data/data/consumer/data-xml_bill_edit/";
?>
                ...
                <div class="sub-form">
                    ...
                    <div class="content">
                    	<table border="0">
                            ...
                            <tr>
                            	<td><label>Show List Type <span>*</span></label></td>
                                <td class="med"></td>
                                <td></td>
                            </tr>
                            <tr>
                                <td colspan="3">
                                	<select id="dty" onchange="show_pdate(this);">
                                    	<option value="0">Un Processed Data</option>
                                        <option value="1">Processed Data</option>
                                	</select>
                                </td>
                            </tr>
							<tr class="gap">
                            ...
                            <tbody id="process_date" style="display:none;">
                            	<tr>
