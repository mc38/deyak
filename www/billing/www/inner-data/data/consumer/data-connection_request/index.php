...
<title></title>
<?php
$link="inner-data/data/consumer/data-connection_request/";
?>
    ...
    <div class="main-container">
    	...
    	<div class="main-panel">
            ...
            <div class="form-data">
				...
				<div class="sub-form">
                	<div class="head">Consumer Details</div>
                    <div class="content">
                    	...
                    	<table border="0">
                            ...
                            <tr class="gap">
                            	<td colspan="3">
                                	<input id="con_date" type="date" autocomplete="off" spellcheck="false" placeholder="Consumer ID" value="" />
                                </td>
                            </tr>
                            <tr class="gap">
                            	<td></td>
                            ...
                            <tr class="gap">
                            	<td colspan="3">
                                	<input id="con_name" type="text" autocomplete="off" spellcheck="false" placeholder="Consumer Name" value="" />
                                </td>
                            </tr>
                            <tr class="gap">
                            	<td></td>
                            ...
                            <tr>
                            	<td colspan="3">
                                	<textarea id="con_add" type="text" autocomplete="off" spellcheck="false" placeholder="Consumer Address"></textarea>
                                </td>
                            </tr>
                            <tr class="gap">
                            	<td></td>
                            ...
                            <tr>
                            	<td><label>Registered Mobile No</label></td>
                                <td class="med"></td>
                            </tr>
                            <tr>
                            	<td colspan="3">
                                	<input id="con_rmn" type="text" autocomplete="off" spellcheck="false" placeholder="Consumer Registered Mobile No" value="" maxlength="10" onkeyup="number_only(this.value,this.id);" onkeypress="number_only(this.value,this.id);" onkeydown="number_only(this.value,this.id);" />
                                </td>
                            </tr>
                            <tr class="gap">
                            	<td></td>
                            ...
                            <tr>
                                ...
                                <td class="med"></td>
                                <td align="right"><button type="button" style="width:200px; margin-left:0px; margin-right:0px;" onclick="create_consumer(this);">Add Request</button></td>
                            </tr>
                        </table>
                    </div>
                </div>
