...
if($u = authenticate()){
	...
	$where = " and c_pass_status=1";
	//$where = "";

	$query = "select * from m_data where c_mydate='". $mydate ."' and c_subdiv_id='". $sid ."' and in_status<>'' and c_import_status=1". $where ." order by in_reading_date";
