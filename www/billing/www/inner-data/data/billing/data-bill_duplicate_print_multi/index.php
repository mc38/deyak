...
<title></title>
<?php
$link="inner-data/data/billing/data-bill_duplicate_print_multi/";
?>
            ...
            <div class="form-data">
                ...
                <div class="sub-form">
                    ...
                    <div class="content-spl" id="data_print">
                        ...
                        <div class="list-scroll stylist-scroll" id="data_list" style="text-align:left; overflow-x:hidden; overflow-y: scroll; font-size:14px; font-family:Arial, Helvetica, sans-serif;">
