...
<title></title>
<?php
$link="inner-data/data/report/data-list_done_undone/";
?>
            ...
            <div class="form-data">
                    ...
                    <div class="content">
                    	<table border="0">
                            ...
                            <tr>
                                ...
                                <td class="med"></td>
                                <td>
                                	<input id="tariff" type="text"  autocomplete="off" spellcheck="false" value="" placeholder="Type Here (For multiple write 10,20)" />
                                </td>
                            </tr>
							<tr class="gap">
                            	<td></td>
                            ...
                            <tr>
                            	<td colspan="3">
                                	...
                                	<input name="report_type" type="radio" checked="checked" value="0" onclick="select_radio(this);" />
                                    <span style="margin-right:50px;">All</span>
                                    
                                    <input name="report_type" type="radio" value="1" onclick="select_radio(this);" />
                                    <span style="margin-right:50px;">Done</span>
                                    
                                    <input name="report_type" type="radio" value="2" onclick="select_radio(this);" />
                                    <span style="margin-right:50px;">Undone</span>
                                    
                                    <input name="report_type" type="radio" value="3" onclick="select_radio(this);" />
                                    <span>XML not generated</span>
                                </td>
                            </tr>
							<tr class="gap">
                            	<td></td>
                ...
                <div class="sub-form">
                    ...
                    <div class="content-spl" id="data_print">        
                        ...
                        <div class="list-scroll stylist-scroll" id="data_list" style="text-align:left; overflow:scroll; font-size:10px; font-family:Arial, Helvetica, sans-serif;">
