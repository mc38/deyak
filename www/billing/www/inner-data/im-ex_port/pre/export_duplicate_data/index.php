...
<title></title>
<?php
$link="inner-data/im-ex_port/export_duplicate_data/";
$ulink = $link;
?>
...
<body><div class="body" align="center">
    ...
    <div class="main-container">
    	...
    	<div class="main-panel">
            ...
            <h2>Export Duplicate XML data</h2>
            </div>
                ...
                <div class="sub-form">
                    ...
                    <div class="content">
                    	<table border="0">
                            ...
                            <tr>
                            	<td><label>Data From No</label></td>
                                <td class="med"></td>
                                <td><label>Data Amount</label></td>
                            </tr>
                            <tr>
                            	<td>
                                	<input id="dfrom" type="text" autocomplete="off" spellcheck="false" placeholder="Data From" onkeydown="number_only(this.value,this.id);" onkeyup="number_only(this.value,this.id);" onkeypress="number_only(this.value,this.id);" />
                                </td>
                                <td class="med"></td>
                                <td>
                                	<input id="dtotal" type="text" autocomplete="off" spellcheck="false" placeholder="Data Total" onkeydown="number_only(this.value,this.id);" onkeyup="number_only(this.value,this.id);" onkeypress="number_only(this.value,this.id);" />
                                </td>
                            </tr>
