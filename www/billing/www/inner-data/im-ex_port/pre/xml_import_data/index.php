...
<title></title>
<?php
$link="inner-data/im-ex_port/xml_import_data/";
$ulink = $link;
?>
    ...
    <div class="main-container">
    	...
    	<div class="main-panel">
            ...
            <div class="form-data">
                            ...
                            <tr class="gap">
                            	<td colspan="3">
                                	<select id="data_type">
                                        ...
                                        <option value="1">One-time Consumer Details Data</option>
                                        <option value="2">Daily Reading Data</option>
                                    </select>
                                </td>
                            </tr>
                        </table>
                ...
                <div class="sub-form">
                	<div class="head">XML File upload and read</div>
                    <div class="content">
                    	<table border="0">
                        	<tr>
                            	<td align="center">
